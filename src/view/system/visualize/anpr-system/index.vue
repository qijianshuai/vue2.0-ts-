    ...
    <div class="container-system-content">
      <div>
        <div class="data">
          <div class="left">
            <p>相机通道编号</p>
            <input type="text" class="no-btn" v-model="state.cameraNo">
            <p>车牌相机端口</p>
      ...
      <div class="btns">
        ...
        <button class="determine" v-if="flag" @click="startUpdateDevices">确定</button>
        <button class="determine" v-else @click="startAddtDevices">确定</button>
      </div>
    </div>
  </main>
</template>
...
@Component
export default class AnprSystem extends Vue {
  private flag = false
